...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_openGL_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_openGL_t qt_meta_stringdata_openGL = {
    {
QT_MOC_LITERAL(0, 6) // "openGL"
...
const QMetaObject openGL::staticMetaObject = { {
    ...
    qt_meta_stringdata_openGL.offsetsAndSize,
    qt_meta_data_openGL,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_openGL_t
, QtPrivate::TypeAndForceComplete<openGL, std::true_type>
